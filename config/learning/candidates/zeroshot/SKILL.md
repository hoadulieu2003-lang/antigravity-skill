...
name: zeroshot
description: >-
  Kỹ năng chuyên gia vận hành cho the-open-engine/zeroshot (1840 ⭐).
  Tự động kích hoạt khi người dùng muốn:
    - Tự động hóa hoặc tích hợp công cụ mã nguồn mở zeroshot vào hệ thống
    - Giải quyết các tác vụ kỹ thuật chuyên sâu liên quan đến Independent executor–verifier orchestration for software changes
    - Thiết lập cấu hình và vận hành lệnh CLI của the-open-engine/zeroshot
  KHÔNG CẦN người dùng phải nhớ tên kỹ thuật 'zeroshot'.
---

# the-open-engine/zeroshot — Cẩm Nang Kỹ Năng Vận Hành Chuyên Sâu

> **Nguồn gốc**: GitHub Repository `https://github.com/the-open-engine/zeroshot`  
> **Độ uy tín cộng đồng**: 1840 ⭐  
> **Trạng thái Quản trị**: `CANDIDATE` (Tuân thủ FRAMEWORK_V2_CAPABILITY_AND_LEARNING_REGISTRY)  
> **Tự động đóng gói lúc**: 2026-09-18 19:42:08Z

---

## 1. Bản Chất Kiến Trúc & Giá Trị Cốt Lõi (Architectural Essence)

* **Mục tiêu cốt lõi**: Independent executor–verifier orchestration for software changes.
