...
description: >-
  ...
  Tự động kích hoạt khi người dùng muốn:
    ...
    - Thiết lập cấu hình và vận hành lệnh CLI của agentconnect-md/agentconnect
  KHÔNG CẦN người dùng phải nhớ tên kỹ thuật 'agentconnect'.
---
...
* **Mục tiêu cốt lõi**: The open-source, multi-agent alternative to Claude Tag. @ any agent, wherever work happens, they work alongside your team, learning as they go.
