...
name: neo
description: >-
  Kỹ năng chuyên gia vận hành cho neomjs/neo (3272 ⭐).
  Tự động kích hoạt khi người dùng muốn:
    - Tự động hóa hoặc tích hợp công cụ mã nguồn mở neo vào hệ thống
    - Giải quyết các tác vụ kỹ thuật chuyên sâu liên quan đến Neo
    - Thiết lập cấu hình và vận hành lệnh CLI của neomjs/neo
  KHÔNG CẦN người dùng phải nhớ tên kỹ thuật 'neo'.
---

# neomjs/neo — Cẩm Nang Kỹ Năng Vận Hành Chuyên Sâu

> **Nguồn gốc**: GitHub Repository `https://github.com/neomjs/neo`  
> **Độ uy tín cộng đồng**: 3272 ⭐  
...
* **Mục tiêu cốt lõi**: Neo.mjs is a self-evolving software organism: a professional end-to-end AI engineering team whose cross-model swarm inhabits live apps via Neural Link, Activ...
...
```bash
# Tham khảo tài liệu gốc tại GitHub: neomjs/neo
