...
name: oh-my-pi
description: >-
  Kỹ năng chuyên gia vận hành cho can1357/oh-my-pi (30722 ⭐).
  Tự động kích hoạt khi người dùng muốn:
    - Tự động hóa hoặc tích hợp công cụ mã nguồn mở oh-my-pi vào hệ thống
    - Giải quyết các tác vụ kỹ thuật chuyên sâu liên quan đến ⌥ Coding agent with the IDE wired in
    - Thiết lập cấu hình và vận hành lệnh CLI của can1357/oh-my-pi
  KHÔNG CẦN người dùng phải nhớ tên kỹ thuật 'oh-my-pi'.
---

# can1357/oh-my-pi — Cẩm Nang Kỹ Năng Vận Hành Chuyên Sâu

> **Nguồn gốc**: GitHub Repository `https://github.com/can1357/oh-my-pi`  
> **Độ uy tín cộng đồng**: 30722 ⭐  
...
* **Mục tiêu cốt lõi**: ⌥ Coding agent with the IDE wired in
