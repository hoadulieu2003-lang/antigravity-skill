...
name: waoowaoo
description: >-
  Kỹ năng chuyên gia vận hành cho waooAI/waoowaoo (14221 ⭐).
  Tự động kích hoạt khi người dùng muốn:
    - Tự động hóa hoặc tích hợp công cụ mã nguồn mở waoowaoo vào hệ thống
    - Giải quyết các tác vụ kỹ thuật chuyên sâu liên quan đến 首家工业级全流程 AI 影视生产平台。Industry-first professional AI Agent platform for controllable film & video production
    - Thiết lập cấu hình và vận hành lệnh CLI của waooAI/waoowaoo
  KHÔNG CẦN người dùng phải nhớ tên kỹ thuật 'waoowaoo'.
---

# waooAI/waoowaoo — Cẩm Nang Kỹ Năng Vận Hành Chuyên Sâu

> **Nguồn gốc**: GitHub Repository `https://github.com/waooAI/waoowaoo`  
> **Độ uy tín cộng đồng**: 14221 ⭐  
> **Trạng thái Quản trị**: `CANDIDATE` (Tuân thủ FRAMEWORK_V2_CAPABILITY_AND_LEARNING_REGISTRY)  
> **Tự động đóng gói lúc**: 2026-09-21 10:42:12Z

---

## 1. Bản Chất Kiến Trúc & Giá Trị Cốt Lõi (Architectural Essence)

* **Mục tiêu cốt lõi**: 首家工业级全流程 AI 影视生产平台。Industry-first professional AI Agent platform for controllable film & video production. From shorts to live-action with Hollywood-standard...
...
```bash
# Tham khảo tài liệu gốc tại GitHub: waooAI/waoowaoo
