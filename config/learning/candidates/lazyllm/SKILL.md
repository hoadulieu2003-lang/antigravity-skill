...
name: lazyllm
description: >-
  Kỹ năng chuyên gia vận hành cho LazyAGI/LazyLLM (3885 ⭐).
  Tự động kích hoạt khi người dùng muốn:
    - Tự động hóa hoặc tích hợp công cụ mã nguồn mở lazyllm vào hệ thống
    - Giải quyết các tác vụ kỹ thuật chuyên sâu liên quan đến Easiest and laziest way for building multi-agent LLMs applications
    - Thiết lập cấu hình và vận hành lệnh CLI của LazyAGI/LazyLLM
  KHÔNG CẦN người dùng phải nhớ tên kỹ thuật 'lazyllm'.
---

# LazyAGI/LazyLLM — Cẩm Nang Kỹ Năng Vận Hành Chuyên Sâu

> **Nguồn gốc**: GitHub Repository `https://github.com/LazyAGI/LazyLLM`  
> **Độ uy tín cộng đồng**: 3885 ⭐  
> **Trạng thái Quản trị**: `CANDIDATE` (Tuân thủ FRAMEWORK_V2_CAPABILITY_AND_LEARNING_REGISTRY)  
> **Tự động đóng gói lúc**: 2026-09-24 10:42:10Z

---

## 1. Bản Chất Kiến Trúc & Giá Trị Cốt Lõi (Architectural Essence)

* **Mục tiêu cốt lõi**: Easiest and laziest way for building multi-agent LLMs applications.
