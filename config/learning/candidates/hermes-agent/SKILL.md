...
name: hermes-agent
description: >-
  Kỹ năng chuyên gia vận hành cho NousResearch/hermes-agent (244616 ⭐).
  Tự động kích hoạt khi người dùng muốn:
    - Tự động hóa hoặc tích hợp công cụ mã nguồn mở hermes-agent vào hệ thống
    - Giải quyết các tác vụ kỹ thuật chuyên sâu liên quan đến The agent that grows with you
    - Thiết lập cấu hình và vận hành lệnh CLI của NousResearch/hermes-agent
  KHÔNG CẦN người dùng phải nhớ tên kỹ thuật 'hermes-agent'.
---

# NousResearch/hermes-agent — Cẩm Nang Kỹ Năng Vận Hành Chuyên Sâu

> **Nguồn gốc**: GitHub Repository `https://github.com/NousResearch/hermes-agent`  
> **Độ uy tín cộng đồng**: 244616 ⭐  
> **Trạng thái Quản trị**: `CANDIDATE` (Tuân thủ FRAMEWORK_V2_CAPABILITY_AND_LEARNING_REGISTRY)  
> **Tự động đóng gói lúc**: 2026-09-12 01:26:45Z

---

## 1. Bản Chất Kiến Trúc & Giá Trị Cốt Lõi (Architectural Essence)

* **Mục tiêu cốt lõi**: The agent that grows with you
