...
description: >-
  ...
  Tự động kích hoạt khi người dùng muốn:
    ...
    - Thiết lập cấu hình và vận hành lệnh CLI của rlaope/oh-my-hermes
  KHÔNG CẦN người dùng phải nhớ tên kỹ thuật 'oh-my-hermes'.
---
...
* **Mục tiêu cốt lõi**: All in one plugin for Hermes Agent ⚚ the coding intelligence, a long-term memory system and model optimized workflow packages
