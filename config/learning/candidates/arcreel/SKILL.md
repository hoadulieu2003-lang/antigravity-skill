...
name: arcreel
description: >-
  Kỹ năng chuyên gia vận hành cho ArcReel/ArcReel (4733 ⭐).
  Tự động kích hoạt khi người dùng muốn:
    ...
    - Thiết lập cấu hình và vận hành lệnh CLI của ArcReel/ArcReel
  KHÔNG CẦN người dùng phải nhớ tên kỹ thuật 'arcreel'.
---

# ArcReel/ArcReel — Cẩm Nang Kỹ Năng Vận Hành Chuyên Sâu

> **Nguồn gốc**: GitHub Repository `https://github.com/ArcReel/ArcReel`  
> **Độ uy tín cộng đồng**: 4733 ⭐  
> **Trạng thái Quản trị**: `CANDIDATE` (Tuân thủ FRAMEWORK_V2_CAPABILITY_AND_LEARNING_REGISTRY)  
> **Tự động đóng gói lúc**: 2026-09-17 10:20:58Z

---

## 1. Bản Chất Kiến Trúc & Giá Trị Cốt Lõi (Architectural Essence)

* **Mục tiêu cốt lõi**: AI Agent 驱动的开源可自部署视频工作台：将小说与剧本转为角色、场景、道具资产、分镜、视频和剪映草稿，支持跨镜头一致性、多供应商与费用追踪 | Self-hosted AI video workspace for stories, storyboards and short-form video produ...
