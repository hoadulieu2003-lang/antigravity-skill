...
```mermaid
flowchart TD
    Founder["👑 ANH (Founder, Chairman & Sole Owner)"]
    CTO["🧠 EM / ANTIGRAVITY (CTO & Lead Orchestrator)"]
    
    Founder <===>|"Chỉ đạo Chiến lược & Quyết định Tối cao (Human Gate)"| CTO
    
    subgraph CorporateDivisions ["5 KHỐI PHÒNG BAN TỰ TRỊ"]
        D1["🔬 KHỐI 1: VIỆN R&D & PHÁP Y KIẾN TRÚC\n(Powered by Boost: DeepInvestigator & DeepCoder)"]
