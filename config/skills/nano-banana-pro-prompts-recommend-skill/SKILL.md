...
description: >-
  Kỹ năng chuyên gia vận hành cho YouMind-OpenLab/nano-banana-pro-prompts-recommend-skill (1854 ⭐).
  Tự động kích hoạt khi người dùng muốn:
    - Tự động hóa hoặc tích hợp công cụ mã nguồn mở nano-banana-pro-prompts-recommend-skill vào hệ thống
    - Giải quyết các tác vụ kỹ thuật chuyên sâu liên quan đến AI skill for OpenClaw & Claude Code — recommend from 10000+ Nano Banana Pro (Gemini) image prompts
    - Thiết lập cấu hình và vận hành lệnh CLI của YouMind-OpenLab/nano-banana-pro-prompts-recommend-skill
  KHÔNG CẦN người dùng phải nhớ tên kỹ thuật 'nano-banana-pro-prompts-recommend-skill'.
---

# YouMind-OpenLab/nano-banana-pro-prompts-recommend-skill — Cẩm Nang Kỹ Năng Vận Hành Chuyên Sâu

> **Nguồn gốc**: GitHub Repository `https://github.com/YouMind-OpenLab/nano-banana-pro-prompts-recommend-skill`  
> **Độ uy tín cộng đồng**: 1854 ⭐  
> **Trạng thái Quản trị**: `CANDIDATE` (Tuân thủ FRAMEWORK_V2_CAPABILITY_AND_LEARNING_REGISTRY)  
> **Tự động đóng gói lúc**: 2026-09-17 16:42:09Z

---

## 1. Bản Chất Kiến Trúc & Giá Trị Cốt Lõi (Architectural Essence)

* **Mục tiêu cốt lõi**: AI skill for OpenClaw & Claude Code — recommend from 10000+ Nano Banana Pro (Gemini) image prompts. Smart search by use case, content remix, sample images.
