...
- **4. Điều ĐƯỢC làm (`do`)**: Thể hiện đầy đủ 4 mốc: 1. Đón khách Hà Nội (07:30) $\to$ 2. Di chuyển Cao tốc $\to$ 3. Điểm nghẽn Khách sạn Hạ Long (Chờ xác nhận 4 phòng) $\to$ 4. Bến tàu Tuần Châu. Đánh dấu nút số 3 bằng màu hổ phách cảnh báo và icon chờ đối tác.
