...
const zipOut = 'C:/Users/game/.gemini/exercises/design_training_005/design_training_005_submission_r01.zip';
const zipCopy = 'C:/Users/game/cdp_reader/design_training_005_submission_r01.zip';

// Python script to build ZIP with pure forward slashes
const pyScript = `
import zipfile, os

base = r'C:\\Users\\game\\.gemini\\exercises\\design_training_005'
out_zip = r'C:\\Users\\game\\.gemini\\exercises\\design_training_005\\design_training_005_submission_r01.zip'
...
fs.writeFileSync('C:/Users/game/cdp_reader/make_zip_005.py', pyScript, 'utf8');
execSync('python C:/Users/game/cdp_reader/make_zip_005.py', { stdio: 'inherit' });
...
`;
fs.writeFileSync('C:/Users/game/cdp_reader/check_zip_005.py', checkPy, 'utf8');
execSync('python C:/Users/game/cdp_reader/check_zip_005.py', { stdio: 'inherit' });
