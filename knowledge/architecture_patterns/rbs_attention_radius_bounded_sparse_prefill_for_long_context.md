# 🏛️ Architectural Pattern: RBS-Attention: Radius-Bounded Sparse Prefill for Long-Context Large Language Models

> **Nguồn nghiên cứu (`Source`)**: ArXiv CS.AI  
> **Đường dẫn gốc (`Reference Link`)**: [RBS-Attention: Radius-Bounded Sparse Prefill for Long-Context Large Language Models](https://arxiv.org/abs/2609.20971)  
