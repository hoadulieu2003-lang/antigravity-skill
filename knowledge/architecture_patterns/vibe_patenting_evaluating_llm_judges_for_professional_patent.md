# 🏛️ Architectural Pattern: Vibe Patenting: Evaluating LLM Judges for Professional Patent-Drafting Agents

> **Nguồn nghiên cứu (`Source`)**: ArXiv CS.AI  
> **Đường dẫn gốc (`Reference Link`)**: [Vibe Patenting: Evaluating LLM Judges for Professional Patent-Drafting Agents](https://arxiv.org/abs/2609.13422)  
