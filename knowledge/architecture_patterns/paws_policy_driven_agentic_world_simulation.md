# 🏛️ Architectural Pattern: PAWS: Policy-driven Agentic World Simulation

> **Nguồn nghiên cứu (`Source`)**: ArXiv CS.AI  
> **Đường dẫn gốc (`Reference Link`)**: [PAWS: Policy-driven Agentic World Simulation](https://arxiv.org/abs/2609.28547)  
