# 🏛️ Architectural Pattern: We just shipped support for the ugliest part of HTTP: Vary

> **Nguồn nghiên cứu (`Source`)**: Cloudflare Engineering  
> **Đường dẫn gốc (`Reference Link`)**: [We just shipped support for the ugliest part of HTTP: Vary](https://blog.cloudflare.com/vary-support/)  
> **Thời điểm tiêu hóa (`Distilled At`)**: 2026-09-22 16:42:14 UTC  
...
Vary support is now available in Cache Rules on every plan.

---

## 2. Cơ chế Kiến trúc Cốt lõi (`Core Architectural Mechanism`)
* **Nguyên lý vận hành**:
  You can normalize known negotiation headers, pass exact values through to the origin when those small differences matter, or bypass cache....
