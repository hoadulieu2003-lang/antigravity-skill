# 🏛️ Architectural Pattern: When Should Forecasting Agents Reason? Behavioral Stress Tests for Reliability Routing

> **Nguồn nghiên cứu (`Source`)**: ArXiv CS.AI  
> **Đường dẫn gốc (`Reference Link`)**: [When Should Forecasting Agents Reason? Behavioral Stress Tests for Reliability Routing](https://arxiv.org/abs/2609.28475)  
