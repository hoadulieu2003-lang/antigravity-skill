# 🏛️ Architectural Pattern: Introducing automatic remediation policies with Cloudflare CASB

> **Nguồn nghiên cứu (`Source`)**: Cloudflare Engineering  
> **Đường dẫn gốc (`Reference Link`)**: [Introducing automatic remediation policies with Cloudflare CASB](https://blog.cloudflare.com/casb-policies/)  
...
* **Nguyên lý vận hành**:
  Security teams can now design event-driven l....
