# 🏛️ Architectural Pattern: Subagents vs Agent Skills: Executing Reusable Knowledge for Long-Horizon Agentic Tasks

> **Nguồn nghiên cứu (`Source`)**: ArXiv CS.AI  
> **Đường dẫn gốc (`Reference Link`)**: [Subagents vs Agent Skills: Executing Reusable Knowledge for Long-Horizon Agentic Tasks](https://arxiv.org/abs/2609.09233)  
