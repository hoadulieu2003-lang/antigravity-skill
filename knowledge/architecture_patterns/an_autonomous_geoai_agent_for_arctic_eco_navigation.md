# 🏛️ Architectural Pattern: An Autonomous GeoAI Agent for Arctic Eco-Navigation

> **Nguồn nghiên cứu (`Source`)**: ArXiv CS.AI  
> **Đường dẫn gốc (`Reference Link`)**: [An Autonomous GeoAI Agent for Arctic Eco-Navigation](https://arxiv.org/abs/2609.09374)  
