# 🏛️ Architectural Pattern: Attention-Aware Routing: Coupling Routing and Attention in MoEs

> **Nguồn nghiên cứu (`Source`)**: ArXiv CS.AI  
> **Đường dẫn gốc (`Reference Link`)**: [Attention-Aware Routing: Coupling Routing and Attention in MoEs](https://arxiv.org/abs/2609.20974)  
