# 🏛️ Architectural Pattern: EvolveTrade: Experience-Driven Policy Refinement for Self-Evolving LLM Trading Agents

> **Nguồn nghiên cứu (`Source`)**: ArXiv CS.AI  
> **Đường dẫn gốc (`Reference Link`)**: [EvolveTrade: Experience-Driven Policy Refinement for Self-Evolving LLM Trading Agents](https://arxiv.org/abs/2609.17632)  
