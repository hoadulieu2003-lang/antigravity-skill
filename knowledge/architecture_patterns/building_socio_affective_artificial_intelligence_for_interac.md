# 🏛️ Architectural Pattern: Building Socio-Affective Artificial Intelligence for Interactive Multi-Agent Simulations

> **Nguồn nghiên cứu (`Source`)**: ArXiv CS.AI  
> **Đường dẫn gốc (`Reference Link`)**: [Building Socio-Affective Artificial Intelligence for Interactive Multi-Agent Simulations](https://arxiv.org/abs/2609.26927)  
