# 🏛️ Architectural Pattern: AI for Societal Impact

> **Nguồn nghiên cứu (`Source`)**: Google AI Official  
> **Đường dẫn gốc (`Reference Link`)**: [AI for Societal Impact](https://blog.google/innovation-and-ai/technology/ai/ai-for-societal-impact/)  
