# 🏛️ Architectural Pattern: 1.1.1.1 now supports post-quantum DNSSEC, all 2,420 bytes of it

> **Nguồn nghiên cứu (`Source`)**: Cloudflare Engineering  
> **Đường dẫn gốc (`Reference Link`)**: [1.1.1.1 now supports post-quantum DNSSEC, all 2,420 bytes of it](https://blog.cloudflare.com/post-quantum-dnssec-1111/)  
