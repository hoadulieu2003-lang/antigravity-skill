# 🏛️ Architectural Pattern: Didactic knowledge or Clinical Cases? How Data Types Shape Medical Large Language Models

> **Nguồn nghiên cứu (`Source`)**: ArXiv CS.AI  
> **Đường dẫn gốc (`Reference Link`)**: [Didactic knowledge or Clinical Cases? How Data Types Shape Medical Large Language Models](https://arxiv.org/abs/2609.22161)  
