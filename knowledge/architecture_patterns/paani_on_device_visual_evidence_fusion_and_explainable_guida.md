# 🏛️ Architectural Pattern: PAANI : On Device Visual Evidence Fusion and Explainable Guidance for River Robot Simulation

> **Nguồn nghiên cứu (`Source`)**: ArXiv CS.AI  
> **Đường dẫn gốc (`Reference Link`)**: [PAANI : On Device Visual Evidence Fusion and Explainable Guidance for River Robot Simulation](https://arxiv.org/abs/2609.22353)  
