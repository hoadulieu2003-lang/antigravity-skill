# 🏛️ Architectural Pattern: Agents can now set up your website’s security with Turnstile Spin

> **Nguồn nghiên cứu (`Source`)**: Cloudflare Engineering  
> **Đường dẫn gốc (`Reference Link`)**: [Agents can now set up your website’s security with Turnstile Spin](https://blog.cloudflare.com/turnstile-spin/)  
> **Thời điểm tiêu hóa (`Distilled At`)**: 2026-09-25 13:42:09 UTC  
...
Misconfiguring Turnstile by skipping backend validation leaves sites exposed to bots.

---

## 2. Cơ chế Kiến trúc Cốt lõi (`Core Architectural Mechanism`)
* **Nguyên lý vận hành**:
  Turnstile Spin fixes incomplete setups by using your preferred AI coding agent to wire up server-side verificat....
